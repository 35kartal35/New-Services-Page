        ...
        <header>
            <div className="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                <Link to="/" className="d-flex align-items-center text-dark text-decoration-none">
                    ...
                    <span className="fs-4">Örnek Bir Hizmet sitesi</span>
                </Link>
                ...
                <nav className="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                    ...
                    <Link to={'/categories'} className={'me-3 py-2 text-dark text-decoration-none'}>
                        Categories
                    </Link>
                    ...
                    <Link to={'/register'} className={'py-2 text-dark text-decoration-none'}>
                        Register
                    </Link>
